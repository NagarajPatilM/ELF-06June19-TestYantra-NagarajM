...
export class HomePage extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            i: [],
            a: '',
           // uid: JSON.parse(window.localStorage.getItem('beans')),
    ...
    getTask() {
        Axios.get('http://localhost:9002/getAssignedTask?email=' + this.state.userEmail.email)
            .then((response) => {
                console.log("data of task",response.data)
                if (response.data.statusCode === 201) {
                    ...
                    console.log('bean if', this.state.onProgress);
                }
    ...
    update(a, b) {
        ...
        console.log("status", b)
        Axios.put('http://localhost:9002/updateTaskStatus?taskId=' + a + '&status=' + b)
            .then((response) => {
